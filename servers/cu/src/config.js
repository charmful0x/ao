...
const CONFIG_ENVS = {
  development: {
    ...
    DISABLE_PROCESS_CHECKPOINT_CREATION: false, // process.env.DISABLE_PROCESS_CHECKPOINT_CREATION !== 'false',
    ...
    PROCESS_MEMORY_CACHE_MAX_SIZE: bytes('1kb'), // process.env.PROCESS_MEMORY_CACHE_MAX_SIZE || bytes('1gb'),
    ...
    PROCESS_MEMORY_CACHE_CHECKPOINT_INTERVAL: ms('5s'), // process.env.PROCESS_MEMORY_CACHE_CHECKPOINT_INTERVAL || 0,
